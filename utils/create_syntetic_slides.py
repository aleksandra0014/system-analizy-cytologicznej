...
# === SEGMENTACJA KOLORU DO CROPu KOMÓRKI ===
...
# === FUNKCJA POMOCNICZA: przeskaluj komórkę z losowym współczynnikiem ===
def resize_cell(cell, original_w, original_h, min_size=64, max_size=128):
...
# === SPRAWDZENIE KOLIZJI Z DOPUSZCZALNYM NAKŁADANIEM ===
def overlaps_soft(x1, y1, w1, h1, boxes, iou_thresh=0.1):

...
def test_model(model_path, test_loader, architecture, model_label):
    results = []
...
if __name__ == "__main__":
    ...
    model_info = [
        (r'classification_models\resnet18\32_0.0001_50_29.06', 'ResNet18', 'resnet18'),
        ('vgg_cytologia30_single_24_0.01.pth', 'VGG16', 'vgg16'),
        ('mine_cnn_0.001.32.50_v2.pth', 'CustomCNN', 'custom_cnn'),
    ]


    for model_path, model_label, architecture in model_info:
        print(f"\nTestowanie modelu: {model_label}")
